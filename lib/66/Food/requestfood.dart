...
import 'food.dart';
import 'package:bmbuffet/66/Food/foodlist.dart';


class FoodScreen66 extends StatefulWidget {
  @override
  _FoodScreen66State createState() => _FoodScreen66State();
}

class _FoodScreen66State extends State<FoodScreen66> {
  final _drinksList = Foodlist66();
  ...
  Future<void> _openWhatsApp(Food66 food) async {

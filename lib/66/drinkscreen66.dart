...
import 'package:bmbuffet/66/drinks_list66.dart';
...
class DrinksScreen66 extends StatefulWidget {
  @override
  _DrinksScreenState createState() => _DrinksScreenState();
}

class _DrinksScreenState extends State<DrinksScreen66> with SingleTickerProviderStateMixin{
  ...
  final _drinksList = DrinksList66();
  final _juicelist = JUICEList66();
  ...
  Future<void> _openWhatsApp2(juice66 juice) async {
  ...
  Future<void> _openWhatsApp(Drink66 drink) async {
    final String apiUrl = 'https://raw.githubusercontent.com/melmorsy2010/Retailtribebuffet/main/66buffetcontact.json';
    final response = await http.get(Uri.parse(apiUrl));
  ...
  void _sendRequest(Drink66 drink) async {
  ...
  Future<void> _sendNotification(Drink66 drink) async {
  ...
  Future<void> _fetchLink() async {
    final response = await http.get(Uri.parse('https://raw.githubusercontent.com/melmorsy2010/Retailtribebuffet/main/66buffetcontact.json'));
    if (response.statusCode == 200) {

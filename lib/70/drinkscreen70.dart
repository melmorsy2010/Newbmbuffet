...
import 'drink70.dart';
import 'drinks_list70.dart';
import 'juice/juice70.dart';
import 'juice/juicelist.dart';



class DrinksScreen70 extends StatefulWidget {
  @override
  _DrinksScreenState createState() => _DrinksScreenState();
}

class _DrinksScreenState extends State<DrinksScreen70> with SingleTickerProviderStateMixin{
  ...
  final _drinksList = DrinksList70();
  final _juicelist = JUICEList70();
  ...
  Future<void> _openWhatsApp2(juice70 juice) async {
  ...
  Future<void> _openWhatsApp(Drink70 drink) async {
    final String apiUrl = 'https://raw.githubusercontent.com/melmorsy2010/Retailtribebuffet/main/70buffetcontact.json';
    final response = await http.get(Uri.parse(apiUrl));
  ...
  void _sendRequest(Drink70 drink) async {
  ...
  Future<void> _sendNotification(Drink70 drink) async {
  ...
  Future<void> _fetchLink() async {
    final response = await http.get(Uri.parse('https://raw.githubusercontent.com/melmorsy2010/Retailtribebuffet/main/70buffetcontact.json'));
    if (response.statusCode == 200) {
